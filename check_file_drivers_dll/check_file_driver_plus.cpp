// Ref: al-khaser
// add more drivers
// g++ -fPIC -static -static-libgcc -static-libstdc++ check_file_driver_plus.cpp -o check_file_driver_plus -lshlwapi
...
int main(){
	...
	const TCHAR* szPaths[] = {
			...
			_T("System32\\drivers\\vmbus.sys"),  			//adding from here
			_T("System32\\drivers\\VMBusHID.sys"),
			_T("System32\\drivers\\vms3cap.sys"),
			_T("System32\\drivers\\vmstorfl.sys"),
